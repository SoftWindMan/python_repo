...
print('人买了长矛后的金币：{}，生命值：{}，攻击力：{}'.format(egg.money, egg.life_value, egg.aggressivity))

print('哈士奇的初始生命值：{}'.format(ha2.life_value))
egg.attack(ha2)   #egg打了ha2一下
print('哈士奇被人徒手攻击一次后的生命值：{}'.format(ha2.life_value))
egg.weapon.prick(ha2) #发动武器技能
print('哈士奇被人用长矛攻击一次后的生命值：{}'.format(ha2.life_value)) #ha2不敌狡猾的人类用武器取胜，血槽空了一半
ha2.bite(egg)
print('人被哈士奇咬一次后的生命值：{}'.format(egg.life_value))
